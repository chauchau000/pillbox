...
from .api.med_routes import med_routes
from .api.glucose_routes import glucose_routes
from .api.appointments_routes import appointments_routes
...
app.register_blueprint(med_routes, url_prefix='/api/meds')
app.register_blueprint(appointments_routes, url_prefix='/api/appointments')
